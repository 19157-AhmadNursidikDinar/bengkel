...
<html>
	<head>
		<title>Admin Service Yamaha Motor Sports</title>
		<style type="text/css">
	...
	<body>
		<div class="wrapper">
			...
			<section class="courses">
				<article>
				<marquee><h2>Klik Gambar Untuk Service</h2></marquee>
				</article>							
				<article>
					<figure>
						<a href="ServiceR25.php"><img src="images/r25_hitam.png" alt="YAMAHA R 25" /></a>
						<figcaption>YAMAHA R 25</figcaption>
					</figure>
					<hgroup>
					<img src="images/logo-r25.png"/>
					</hgroup>
				</article>
				<article>
					<figure>
						<a href="ServiceR15.php"><img src="images/r15_hitam.png" alt="YAMAHA R 15" /></a>
						<figcaption>YAMAHA R 25</figcaption>
					</figure>
					<hgroup>
					<img src="images/logo-r15.png"/>
					</hgroup>
				</article>
			</section>
			<aside>
				<section class="logo">
					<h2>Yamaha Motor Sport</h2>
				...
				<section class="contact-details">
					<h2>Contact US</h2>
					<p align="center">Yamaha Motor Sport<br>
						Service & Parts</p>
				</section>
			</aside>
			<footer>
				&copy; 2015 Yamaha Motor Sport
			</footer>
		</div><!-- .wrapper -->
	</body>
</html>