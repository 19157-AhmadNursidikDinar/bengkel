...
if (isset($_POST['tambahparts'])){
	$dok1=$_POST['NoParts'];
	$dok2=$_POST['NamaParts'];
	$dok3=$_POST['Model'];
	$dok4=$_POST['Harga'];
	mysql_query ("INSERT INTO parts VALUE ('$dok1','$dok2','$dok3','$dok4')");
	}
	if (isset($_GET['NoParts'])){
	$NoParts=$_GET['NoParts'];
	mysql_query ("DELETE FROM parts WHERE NoParts='$NoParts'");
	}
if (isset($_POST['edit'])){
	$dok1=$_POST['NoParts'];
	$dok2=$_POST['NamaParts'];
	$dok3=$_POST['Model'];
	$dok4=$_POST['Harga'];
	mysql_query ("UPDATE parts SET NamaParts='$dok2', Model='$dok3', Harga='$dok4' WHERE NoParts='$dok1'");
	}
?>
...
<html>
			...
			<header>
				<nav>
					<ul>
						...
						<li><a href="AdminParts.php" class="current">Parts</a></li>
	...
	<?php
	$i=0;
	$query = mysql_query("SELECT * FROM parts WHERE Model='YZF-R15'");
	...
	?>
			...
			<tr align="center">
				...
				<td><a href="EditParts.php?NoParts=<?php echo $data['NoParts']; ?>">Edit</a> -
				<a href="AdminParts.php?NoParts=<?php echo $data['NoParts']; ?>">Delete</a></td>
			</tr>
	<?php } ?>
	</table>
		<table width="80%" border="1" align="center" >
			<tr align="center" bgcolor="red">
				<h2 align="center">YZF - R25</h2>
				<td><b>No</b></td>
				<td><b>No Parts</b></td>
				<td><b>Nama Parts</b></td>
				<td><b>Model</b></td>
	...
	<?php
	$i=0;
	$query = mysql_query("SELECT * FROM parts WHERE Model='YZF-R25'");
	while ($data= mysql_fetch_assoc ($query)){
	$i++;
	?>
	...
	<?php } ?>
				...
				<hgroup>
					<form method="post" action="TambahParts.php" align="center">
						<input type='submit' value='Tambah Parts'>
					</form>
				</hgroup>
				</article>    				
			</section>
