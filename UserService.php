	...
	<body>
		<div class="wrapper">
			<header>
				<nav>
					<ul>
						...
						<li><a href="UserService.php" class="current">Service</a></li>
			...
			<section class="courses">
				...
				<article>
					<figure>
						<a href="UserR25.php"><img src="images/r25_hitam.png" alt="YAMAHA R 25" /></a>
				...
				<article>
					<figure>
						<a href="UserR15.php"><img src="images/r15_hitam.png" alt="YAMAHA R 15" /></a>
						<figcaption>YAMAHA R 25</figcaption>
					</figure>
					<hgroup>
